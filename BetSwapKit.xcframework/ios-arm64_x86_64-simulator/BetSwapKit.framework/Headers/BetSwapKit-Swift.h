...
#ifndef BETSWAPKIT_SWIFT_H
#define BETSWAPKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BetSwapKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10BetSwapKit24BetSwapAdsViewController")
@interface BetSwapAdsViewController : UIViewController <UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate>
...
SWIFT_PROTOCOL("_TtP10BetSwapKit32BetSwapAdsViewControllerDelegate_")
@protocol BetSwapAdsViewControllerDelegate
- (void)betSwapAdsViewControllerDidDismis:(BetSwapAdsViewController * _Nullable)betSwapAdsViewController;
@end


SWIFT_CLASS("_TtC10BetSwapKit10BetSwapKit")
@interface BetSwapKit : NSObject
...
SWIFT_CLASS("_TtC10BetSwapKit22BetSwapKitAdButtonView")
@interface BetSwapKitAdButtonView : UIView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
